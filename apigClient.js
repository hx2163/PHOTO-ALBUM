...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://dkjgsp69vl.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.uploadBucketFilenamePut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'bucket', 'Access-Control-Allow-Headers', 'Accss-Control-Allow-Origin', 'Access-Control-Allow-Methods'], ['body']);
        ...
        var uploadBucketFilenamePutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Access-Control-Allow-Headers', 'Accss-Control-Allow-Origin', 'Access-Control-Allow-Methods']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
    ...
    apigClient.uploadBucketFilenameOptions = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Accss-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Methods'], ['body']);
        ...
        var uploadBucketFilenameOptionsRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Accss-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'Access-Control-Allow-Methods']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
